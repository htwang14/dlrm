...
CUDA_VISIBLE_DEVICES=0 python dlrm_s_pytorch.py \
    ...
    --load-model results/300-150-1_lr0.1/model.pth \
    --use-gpu \
    --nepochs 3 \
...
CUDA_VISIBLE_DEVICES=1 python dlrm_s_pytorch.py \
    ...
    --test-num-workers=16 \
    --arch-interaction-op cat \
    --load-model results/240-120-1_lr0.1/model.pth \
    --use-gpu \
    --nepochs 3 \
    2>&1 | tee 240-120-1_lr0.1.log

# FLOPs = 2*432*224+224+2*224*112+112+2*112+1 = 244273
...
CUDA_VISIBLE_DEVICES=2 python dlrm_s_pytorch.py \
    ...
    --test-num-workers=16 \
    --arch-interaction-op cat \
    --load-model results/224-112-1_lr0.1/model.pth \
    --use-gpu \
    --nepochs 3 \
